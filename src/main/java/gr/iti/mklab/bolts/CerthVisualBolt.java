...
/**
 * An abstract bolt with visual indexing and search capabilities which logs
 * its output to a dedicated file, whose path is defined in storm_config.ini
 *
 * @author kandreadou
 */
public abstract class CerthVisualBolt extends BaseRichBolt {
    ...
    /**
     * Abstract Certh Visual Bolt constructor
     *
     ...
     */
    public CerthVisualBolt(String strExampleEmitFieldsId, String assessmentId, String learningFolder, String serviceHost, String strLogBaseDir, String strLogPattern, Level logLevel) throws Exception {
        super();
    ...
    private void createLogger() {
        ...
        try {
            ...
            String strLogName = getLoggerName() + "_pid" + strPID + ".log";
    ...
    public abstract void processJSONObject(JSONObject jsonObject);
